...
<span component="$UI/system/components/justep/windowDialog/windowDialog" xid="mainWindowDialog" src="$UI/CHDPer/EMPer.w"></span><div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1" style="background-color:#F2F2F2;">
  ...
  <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver" direction="auto" xid="unitpopOver" opacity="0.7" dismissible="false">
   ...
   <div class="x-popOver-content" xid="div26" style="width:112px;height:97px;">
    <img src="$UI/CHDPer/img/1405066128222.gif" alt="" xid="image16" style="height:97px;width:100%;" height="100%"></img></div> </div>
  </div>