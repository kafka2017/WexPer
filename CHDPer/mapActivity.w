...
<div component="$UI/system/components/justep/windowContainer/windowContainer" class="x-window-container" xid="mapTrackContainer"></div>
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="mapTrackDialog" src="$UI/CHDPer/mapTrackActivity.w" routable="true" forceRefreshOnOpen="true"></span></div>
